...
A simple Model View Presenter framework for the Winforms platform, based on https://github.com/DavidRogersDev/WinformsMVP

Updated dependencies to latest and refactored to work and target .net10.0-windows OR net462.
